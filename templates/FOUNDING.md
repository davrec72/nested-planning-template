...
- After the first valid `planning/CURRENT.md` publication, this founding exception expires.
...
If the repository is a child of an accepted parent plan, do not create an independent root founding record merely for convenience. Use the accepted parent contract/delegation as the bootstrap authority under `planning/PUBLICATION.md`.