...
- [ ] After operational adoption, candidate preserves the fixed logical inventory identity/locator, serialization mechanism, coordination domain and history contract under EXECUTION.md; same-version migration is rejected before ref movement. Initial adoption reconciles the complete baseline; holder/claim/runtime changes inside the same mechanism remain permitted under current authority.
