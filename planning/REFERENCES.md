...
3. **Approve and publish P1.** Pre-existing P0 authority approves the exact P1 candidate. Retain the candidate and carrier evidence and commit its trusted publication event under PR24's existing protocol. Only then does P1 become an accepted `parent_relationship_plan_ref`.
